...
- campo: input
  tipo: string
  obrigatorio: true
  validacao: user input or upstream artifact
Saida:
- campo: output
  tipo: file
  obrigatorio: true
...
Checklist:
- '[ ] Task completed'
description: '**Task ID:** CCM-CONFIG-002'
---
...
**AIOX-specific deny rules (if AIOX project detected):**

| Pattern | Protects | Severity if Missing |
|---------|----------|---------------------|
| `Edit(framework core/**)` | L1 Framework Core | HIGH |
| `Edit(constitution.md)` | Constitution | HIGH |
