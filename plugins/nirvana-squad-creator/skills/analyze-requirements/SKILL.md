...
Checklist:
  ...
  post-conditions:
  - '[ ] analysis.md criado com todas as seções obrigatórias (domínio, capacidades,
    roles, dependências)'
  - '[ ] component-registry.md criado com nomes canônicos de agentes, tasks e workflows'
  - '[ ] Nenhuma capacidade redundante no registry'
  - '[ ] Nomes canônicos seguem convenções (kebab-case para IDs, camelCase() para
    tasks)'
Performance:
...
Metadata:
  story: Como usuário, preciso que meu objetivo em linguagem natural seja decomposto
    em estrutura de squad
  version: 1.0.0
  dependencies: []
