...
Checklist:
  ...
  - '[ ] squad.yaml gerado com name, version, description, aios.minVersion, aios.type,
    components'
...
Metadata:
  story: Como pipeline, preciso gerar workflows, squad.yaml, config e README a partir
    de agentes e tasks
  version: 1.0.0
  dependencies:
  - analyzeRequirements()
