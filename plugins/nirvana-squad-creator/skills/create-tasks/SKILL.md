...
Checklist:
  ...
  - '[ ] Contratos Entrada/Saída são encadeados — output da task N referencia input
    da task N+1'
...
Metadata:
  story: Como pipeline, preciso gerar definições de tasks com contratos Entrada/Saída
    encadeados
  version: 1.0.0
  dependencies:
  - analyzeRequirements()
