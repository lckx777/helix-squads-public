...
claude plugin install synthetic-intelligence-factory@helix-squads-public
```
...
![tasks](https://img.shields.io/badge/tasks-4-blue)
![workflows](https://img.shields.io/badge/workflows-2-blue)
...
<details>
<summary>The 7-Layer Architecture</summary>

| Layer | What It Models | Word Count |
|-------|---------------|-----------|
...
Forged by [l0z4n0](https://github.com/lozanojoaog11) | [squads.sh](https://squads.sh)

First forged: 2026-03-17

> "The map is not the territory — but a good map changes how you navigate it."

<!-- The Forge Rule: depth over breadth. A shallow intelligence fails at the first edge case. -->
